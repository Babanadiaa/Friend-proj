...
export default function Header() {
    ...
    return (
        <header className={`z-20 fixed w-full p-3 sm:px-10 flex justify-between items-center transition-all duration-300 ${scrolled ? 'backdrop-blur-md bg-white/1 shadow-lg' : 'bg-white/0 backdrop-blur-none shadow-none'}`}>
            <a href="#" className='sm:text-2xl text-xl text-[#c1c7c6] w-full'>Andrew Machmur</a>
            ...
            {menuOpen && (
                <div className="phone__menu absolute top-0 left-0 w-full h-screen bg-black/90 flex justify-center items-center
                    ...
                    <nav className=' flex flex-col  z-20 justify-end items-center'>
                        <a href="#Portfolio" onClick={() => setMenuOpen(false)} className='  text-[#9ea2a2]  fex text-2xl pt-8 relative '>Portfolio</a>
                        <a href="#About" onClick={() => setMenuOpen(false)} className=' text-[#9ea2a2]   text-2xl pt-8 relative '>About</a>
                        <a href="#Contact" onClick={() => setMenuOpen(false)} className='  text-[#9ea2a2]   text-2xl pt-8 relative '>Contact</a>
                    </nav>
